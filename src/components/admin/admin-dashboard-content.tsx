...
export function AdminDashboardContent({ user }: AdminDashboardContentProps) {
  ...
  const systemCards = [
    ...
    },
    {
      ...
      value: stats.incidentsToday === 0 ? "Secure" : `${stats.incidentsToday} Alerts`,
      status: stats.incidentsToday === 0 ? "excellent" : "warning",
      icon: Shield,
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                ...
                <span className="font-medium">{stats.checkinsToday}</span>
              </div>
