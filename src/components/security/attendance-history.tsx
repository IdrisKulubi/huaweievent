...
import { attendanceRecords, jobSeekers, users } from "@/db/schema";
import { eq, desc, and, gte } from "drizzle-orm";
import { Badge } from "@/components/ui/badge";
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";
import { Clock, User, MapPin, CheckCircle, AlertTriangle } from "lucide-react";
...
export async function AttendanceHistory({ securityId, limit = 10 }: AttendanceHistoryProps) {
  // Get recent attendance records verified by this security personnel
  const recentRecords = await db
    ...
    .where(eq(attendanceRecords.verifiedBy, securityId))
