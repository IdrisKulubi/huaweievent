/**
 * R2 Storage Utilities for CV Management
 */

// Your R2 public domain
const R2_PUBLIC_URL = process.env.NEXT_PUBLIC_R2_PUBLIC_URL || "https://pub-c1f2d2c1ecc24b4bac78666e0a1644a7.r2.dev";

/**
 * Generate the full R2 URL from a stored CV path
...
/**
 * Extract the storage path from a full R2 URL for database storage
 * @param fullUrl - The complete R2 URL
